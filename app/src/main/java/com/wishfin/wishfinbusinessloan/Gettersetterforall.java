...
public class Gettersetterforall {
    ...
    public String getSelected_banks() {
        return selected_banks;
    }

    public void setSelected_banks(String selected_banks) {
        this.selected_banks = selected_banks;
    }

    String selected_banks;
    ...
    public void setShow_logo(String show_logo) {
        this.show_logo = show_logo;
    }

    public String getApi_to_use() {
        return api_to_use;
    }

    public void setApi_to_use(String api_to_use) {
        this.api_to_use = api_to_use;
    }
